...
export const CROPS = [
  ...
  { id: 'sitaw', name: 'Sitaw', emoji: '🫛', category: 'starter', seedCost: 4, growTime: 30, sellPrice: 6, xp: 3, unlockLevel: 3, minWeight: 0.1, maxWeight: 0.5 },
  ...
  { id: 'dragonfruit', name: 'Dragon Fruit', emoji: '🐉', category: 'premium', seedCost: 60, growTime: 250, sellPrice: 120, xp: 30, unlockLevel: 65, minWeight: 0.3, maxWeight: 1.0 },
  { id: 'durian', name: 'Durian', emoji: '🦔', category: 'premium', seedCost: 80, growTime: 300, sellPrice: 200, xp: 40, unlockLevel: 80, minWeight: 2.0, maxWeight: 6.0 },
  { id: 'mangosteen', name: 'Mangosteen', emoji: '🟣', category: 'premium', seedCost: 100, growTime: 280, sellPrice: 150, xp: 35, unlockLevel: 95, minWeight: 0.2, maxWeight: 0.5 },
];
